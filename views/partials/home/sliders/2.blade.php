                            ...
                            <div class="div-table">
                                <div class="div-cell">
                                    <div class="caption-content">
                                        <h3 class="caption-subtitle">{!! trans('themes::theme.reservation.slogan2') !!}</h3>
                                        <h4 class="caption-title">{{ trans('themes::theme.reservation.call now') }} {!! setting('theme::phone') !!}</h4>
                                        <!-- Search form -->
                                        <div class="row">
